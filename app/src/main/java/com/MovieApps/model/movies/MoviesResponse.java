...
public class MoviesResponse implements Parcelable {
    ...
    @SerializedName("results") private List<ListMoviesResponse> results;
    ...
    protected MoviesResponse(Parcel in) {
        ...
        results = in.createTypedArrayList(ListMoviesResponse.CREATOR);
    }
    ...
    public List<ListMoviesResponse> getResults() {
        return results;
    }

    public void setResults(List<ListMoviesResponse> results) {
