...
public class ListSeriesResponse implements Parcelable {
    ...
    protected ListSeriesResponse(Parcel in) {
    ...
    public static final Creator<ListSeriesResponse> CREATOR = new Creator<ListSeriesResponse>() {
        @Override
        public ListSeriesResponse createFromParcel(Parcel in) {
            return new ListSeriesResponse(in);
        }

        @Override
        public ListSeriesResponse[] newArray(int size) {
            return new ListSeriesResponse[size];
        }
    };
}
